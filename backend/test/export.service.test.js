...
describe('export service', () => {
  it('returns an xlsx workbook with stable headers and row values', async () => {
    const service = createExportService({ rowsProvider: async () => [{ tanggalKegiatan: '2026-08-22', user: { nama: 'Ayu', nomorHp: '08123' }, cluster: { clusterName: 'RW 01', desa: { namaDesa: 'Dewasari' } }, pekerjaan: { namaPekerjaan: 'ODN' }, keterangan: 'Selesai', diterima: true }] })
